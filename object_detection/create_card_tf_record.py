...
flags.DEFINE_string('label_map_path', 'object_detection/data/card_label_map.pbtxt',
...
def main(_):
  ...
  logging.info('Reading from Card dataset.')
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'card_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'card_val.record')
